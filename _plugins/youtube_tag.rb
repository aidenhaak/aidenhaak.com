...
module Jekyll
  class YouTubeTag < Liquid::Tag
    ...
    def render(context)
      ouptut = super
      if @videoid
        video = %Q{<div class="video-container"><iframe width="#{@width}" height="#{@height}" src="http://www.youtube.com/embed/#{@videoid}?rel=0" frameborder="0" allowfullscreen></iframe></div>}
      else
